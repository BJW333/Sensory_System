...
for det in _AVAILABLE_DETECTORS:
    try:
        ...
        test_img = np.ones((250, 250, 3), dtype=np.uint8) * 128  # Gray test image
...
def obj_person_recog_loop(camera_manager, *, show_debug: bool = False, stop_event: Optional[threading.Event] = None,):
    ...
    Args:
        ...
        show_debug: If True, enables debug logging and saves debug images
        ...
        while stop_event is None or not stop_event.is_set():
            ...
            if frame_count % CONFIG["face_every_n_frames"] == 0:
                ...
                for idx, face in enumerate(faces):
                    ...
                    if assigned_person is None or max_iou < 0.03: #used to be 0.10 for IoU threshold

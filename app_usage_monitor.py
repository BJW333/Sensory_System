# app_usage_monitor.py – foreground-app tracking for ARGUS (macOS-only)
# ---------------------------------------------------------------------------
# Upgrades vs. original:
#   • optional stop_event and thread wrapper for graceful shutdown
#   • batches Context updates, adds initial keys, and clears keys on stop
#   • robust error handling around NSWorkspace (sometimes raises on fast user switch)
#   • logging instead of raw print; exposes monitor status clearly
#   • configurable CHECK_INTERVAL constant at top
# ---------------------------------------------------------------------------

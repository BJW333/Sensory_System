# idle_detection_combined_fixed.py – presence, gaze & activity-state logic
# ---------------------------------------------------------------------------
# Key fixes & improvements over original:
#   • One-time MediaPipe FaceMesh init (heavy) – reused for every frame
#   • Config constants gathered at top; easy tuning
#   • Robust thread-safe Context updates with CONTEXT.batch()
#   • Loop pacing + stop_event for graceful shutdown
#   • Proper logging instead of print spam
#   • Reduced double-processing of FaceMesh in debug branch
#   • Added eye-landmark display only when debug flag set
# ---------------------------------------------------------------------------
